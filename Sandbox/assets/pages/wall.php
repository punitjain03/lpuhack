<?php
 ...
 ?>
    <div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        <div class="col-md-8 col-sm-12" style="max-width:193vw">
...
<div class="d-flex justify-content-between">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div>
                <h6 class="text-muted p-2">You Can Team-up with Them</h6>
                <?php
...
<div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-primary followbtn" data-user-id='<?=$suser['id']?>' >Collab</button>
