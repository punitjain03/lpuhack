<?php global $user;?>
    <nav class="navbar navbar-expand-lg navbar-light bg-red border" >
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/CollabIt.png" alt="" height="100">
                </a>

                <form class="d-flex" id="searchform">
                    <input class="form-control me-5" type="search" id="search" placeholder="Looking for Collab..." 
...
<p class="text-center text-muted">Enter your Role</p>
